...
export default function Verificar(){
    ...
    const modales = [ <Trazabilidad idProceso={modal.data.codoprid} idDocumento={modal.data.id}  ruta={'circular'} /> ];
    ...
    const inicio = () =>{
        setLoader(true);
        instance.post('/admin/producion/documental/circular/list', {tipo:'HISTORICOS'}).then(res=>{
            setData(res.data);
            setLoader(false);
        }) 
    }
