...
export default function Producir(){
    ...
    const verificarArea = (area) =>{
        ...
        setModal({open: true, vista: 1, data:data, titulo: 'Registrar nuevo tipo documental circular del área '+area.depenombre.toLowerCase(), tamano: 'bigFlot'});
    }
    ...
    const tituloModal = ['Selecionar área de producción documental', 
                        ...
                        'Editar tipo documental circular',
