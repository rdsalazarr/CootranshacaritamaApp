...
export default function Producir(){
    ...
    const modales = [
                        <VerificarArea cerrarModal={cerrarModal} verificarArea={verificarArea} ruta={'oficio'} />,
    ...
    return (
        <Box>
            ...
            : ((accion === 'N') ?
                ...
                :  
                <Box>
                    <NewEdit tipo={'U'} id={idDocumento} ruta='P' volver={inicio}  mensaje={'Editar tipo documental oficio'} />
                </Box>
                )
            }
