...
export default function Verificar(){
    ...
    const modales = [ <Trazabilidad idProceso={modal.data.codoprid} idDocumento={modal.data.id} ruta={'citacion'} /> ];
    ...
    const inicio = () =>{
        setLoader(true);
        instance.post('/admin/producion/documental/citacion/list', {tipo:'HISTORICOS'}).then(res=>{
            setData(res.data);
            setLoader(false);
        }) 
    }
