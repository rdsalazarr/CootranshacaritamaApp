...
export default function Producir(){
    ...
    const verificarArea = (area) =>{
        ...
        setModal({open: true, vista: 1, data:data, titulo: 'Registrar nuevo tipo documental acta del área '+area.depenombre.toLowerCase(), tamano: 'bigFlot'});
    }

    const modales = [
                        <Verificar cerrarModal={cerrarModal} verificarArea={verificarArea} ruta={'acta'} />,
