...
export default function List(){
    ...
    const modales = [
                        ...
                        <Eliminar id={(tipo === 2) ? modal.data.tireveid : null} ruta={'/admin/direccion/transporte/referencia/destroy'} cerrarModal={cerrarModal} />
                    ];

    const tituloModal = ['Nueva referencia de vehículo','Editar referencia de vehículo',''];
    ...
    const inicio = () =>{
        setLoader(true);
        instance.get('/admin/direccion/transporte/referencia/list').then(res=>{
            setData(res.data);
            setLoader(false);
        }) 
    }
