...
export default function New({data, tipo}){
    ...
    const [formData, setFormData] = useState(
                    (tipo !== 'I') ? {codigo: data.tireveid, nombre: data.tirevenombre, estado: data.tireveactivo, tipo:tipo 
    ...
    const handleSubmit = () =>{
        setLoader(true);
        instance.post('/admin/direccion/transporte/referencia/salve', formData).then(res=>{
