...
export default function List(){
    ...
    const modales = [
                        ...
                        <Eliminar id={(tipo === 2) ? modal.data.timaveid : null} ruta={'/admin/direccion/transporte/marca/destroy'} cerrarModal={cerrarModal} />
                    ];

    const tituloModal = ['Nueva marca de vehículo','Editar marca de vehículo',''];
    ...
    const inicio = () =>{
        setLoader(true);
        instance.get('/admin/direccion/transporte/marca/list').then(res=>{
            setData(res.data);
            setLoader(false);
        }) 
    }
