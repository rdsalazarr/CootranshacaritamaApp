...
export default function New({data, tipo}){
    ...
    const [formData, setFormData] = useState(
                    (tipo !== 'I') ? {codigo: data.timaveid, nombre: data.timavenombre, estado: data.timaveactiva, tipo:tipo 
    ...
    const handleSubmit = () =>{
        setLoader(true);
        instance.post('/admin/direccion/transporte/marca/salve', formData).then(res=>{
