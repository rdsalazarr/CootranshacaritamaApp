...
export default function New({data, tipo}){
    ...
    const [formData, setFormData] = useState(
                    (tipo !== 'I') ? {codigo: data.ticoveid, nombre: data.ticovenombre, estado: data.ticoveactivo, tipo:tipo 
    ...
    const handleSubmit = () =>{
        setLoader(true);
        instance.post('/admin/direccion/transporte/color/salve', formData).then(res=>{
