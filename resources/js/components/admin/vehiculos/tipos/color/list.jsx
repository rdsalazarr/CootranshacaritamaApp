...
export default function List(){
    ...
    const modales = [
                        ...
                        <Eliminar id={(tipo === 2) ? modal.data.ticoveid : null} ruta={'/admin/direccion/transporte/color/destroy'} cerrarModal={cerrarModal} />
                    ];

    const tituloModal = ['Nuevo color de vehículo','Editar color de vehículo',''];
    ...
    const inicio = () =>{
        setLoader(true);
        instance.get('/admin/direccion/transporte/color/list').then(res=>{
            setData(res.data);
            setLoader(false);
        }) 
    }
