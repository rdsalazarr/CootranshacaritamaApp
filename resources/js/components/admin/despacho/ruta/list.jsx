...
export default function List(){
    ...
    const modales = [
                        ...
                        <Eliminar id={(tipo === 2) ? modal.data.persid : null} ruta={'/admin/despacho/ruta/destroy'} cerrarModal={cerrarModal} />
                    ];

    const tituloModal = ['Nueva ruta','Editar ruta',''];
        ...
        <Box>
            <Card className={'cardContainer'} >
                ...
                <Box sx={{maxHeight: '35em', overflow:'auto'}} sm={{maxHeight: '35em', overflow:'auto'}}>
                    <TablaGeneral
                        datos={data}
                        titulo={['Departamento origen','Municipio origen','Departamento destino', 'Municipio destino','Activa','Actualizar','Eliminar']}
