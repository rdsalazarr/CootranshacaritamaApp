...
export default function List(){
    ...
    const modales     = [ <EjecutarProcesoAutomatico data={modal.data} cerrarModal={cerrarModal} proceso='NOCHE' /> ];
    const tituloModal = ['Ejecutar proceso noche'];
    ...
    const inicio = () =>{
        setLoader(true);
        instance.post('/admin/procesos/automaticos', {tipo:'N'}).then(res=>{
            setData(res.data);
            setLoader(false);
        })
    }
