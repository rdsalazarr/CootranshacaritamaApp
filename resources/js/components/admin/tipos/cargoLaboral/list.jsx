...
export default function List(){
    ...
    const modales = [
                        ...
                        <Eliminar id={(tipo === 2) ? modal.data.carlabid : null} ruta={'/admin/cargoLaboral/destroy'} cerrarModal={cerrarModal} />
                    ];

    const tituloModal = ['Nuevo cargo laboral','Editar cargo laboral',''];
    ...
    const inicio = () =>{
        setLoader(true);
        instance.get('/admin/cargoLaboral/list').then(res=>{
            setData(res.data);
            setLoader(false);
        }) 
    }
