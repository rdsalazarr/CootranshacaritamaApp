...
export default function List(){
    ...
    const modales = [
                        ...
                        <Eliminar id={(tipo === 2) ? modal.data.saluid : null} ruta={'/admin/tipoSaludo/destroy'} cerrarModal={cerrarModal} />
                    ];

    const tituloModal = ['Nuevo saludo','Editar saludo',''];
    ...
    const inicio = () =>{
        setLoader(true);
        instance.get('/admin/tipoSaludo/list').then(res=>{
            setData(res.data);
            setLoader(false);
        }) 
    }
