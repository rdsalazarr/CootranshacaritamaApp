...
const menuComponente = [
    ...
    {id:27,componente : <SancionarAsociados />},
    ...
    {id:33,componente : <DistribucionVehiculo />},
    {id:34,componente : <SuspenderVehiculo />},
    {id:35,componente : <LineaCredito />},
    {id:36,componente : <SolicitudCredito />},
    {id:37,componente : <AprobacionCredito />},
    {id:38,componente : <DesembolsarCredito />},
    {id:39,componente : <HistorialSolicitudCredito />},
    {id:40,componente : <CobroCartera />},
    {id:41,componente : <Rutas />},
    {id:42,componente : <Planillas />},
    {id:43,componente : <Encomiendas />},
