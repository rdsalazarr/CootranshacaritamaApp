...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('encomienda', function (Blueprint $table) {
            ...
            $table->string('encovalordeclarado', 8)->comment('Valor declarado en la encomienda');
            $table->string('encovalorenvio', 8)->comment('Valor del envio de la encomienda');
            $table->string('encovalordomicilio', 8)->nullable()->comment('Valor del domicilio de la encomienda');
            $table->string('encovalorcomisionseguro', 8)->comment('Valor de comisión del seguro de la encomienda');
            $table->string('encovalorcomisionvehiculo', 8)->comment('Valor de comisión para el vehículo que transporta  la encomienda');
            $table->string('encovalorcomisionagencia', 8)->comment('Valor de comisión para la agencia que envia la encomienda');
            $table->string('encovalorcomisionempresa', 8)->comment('Valor de comisión para la empresa sobre la encomienda');
