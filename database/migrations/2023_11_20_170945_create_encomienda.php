...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('encomienda', function (Blueprint $table) {
            ...
            $table->decimal('encovalordeclarado', 10, 2)->comment('Valor declarado en la encomienda');
            $table->decimal('encovalorenvio', 10, 2)->comment('Valor del envío de la encomienda');
            $table->decimal('encovalordomicilio', 10, 2)->nullable()->comment('Valor del domicilio de la encomienda');
            $table->decimal('encovalorcomisionseguro', 10, 2)->comment('Valor de comisión del seguro de la encomienda');
            $table->decimal('encovalorcomisionvehiculo', 10, 2)->comment('Valor de comisión para el vehículo que transporta la encomienda');
            $table->decimal('encovalorcomisionagencia', 10, 2)->comment('Valor de comisión para la agencia que envía la encomienda');
            $table->decimal('encovalorcomisionempresa', 10, 2)->comment('Valor de comisión para la empresa sobre la encomienda');
            $table->decimal('encovalortotal', 8, 2)->comment('Valor total de la encomienda');
