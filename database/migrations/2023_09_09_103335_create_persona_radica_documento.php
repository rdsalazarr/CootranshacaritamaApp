...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('personaradicadocumento', function (Blueprint $table) {
            ...
            $table->string('peradoprimerapellido', 40)->comment('Nombre de la persona que radica el documento');
            ...
            $table->string('peradocodigodocumental', 20)->nullable()->comment('Código documental del documento que se recibe');
