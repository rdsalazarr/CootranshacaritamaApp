...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('informacionconfiguracioncorreo', function (Blueprint $table) {
            ...
            $table->string('incococlave', 30)->comment('Clave del correo para acceder a la plataforma');
            $table->string('incococlaveapi', 30)->comment('Clave de la api para autenticar y poder enviar el corro');
            $table->string('incocopuerto', 30)->comment('Puerto por el cual se envia el correo');
            $table->timestamps();
