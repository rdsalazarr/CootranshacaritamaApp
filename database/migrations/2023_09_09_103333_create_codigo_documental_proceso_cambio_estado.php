...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('coddocumprocesocambioestado', function (Blueprint $table) {
            ...
            $table->smallInteger('codpceuserid')->unsigned()->comment('Identificador del usuario que crea el estado del documento');
            ...
            $table->foreign('codpceuserid')->references('usuaid')->on('usuario')->onUpdate('cascade')->index('fk_usercodpce');
        });
    }
