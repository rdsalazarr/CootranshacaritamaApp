...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('coddocumprocesoacta', function (Blueprint $table) {
            ...
            $table->string('codopalugar', 80)->comment('Lugar donde se realiza el acta');
            $table->string('codopaquorum', 200)->comment('Quorum reglamentario para el acta');
            $table->string('codopaordendeldia', 2000)->comment('Orden del dñia del acta');
            $table->string('codopainvitado', 2000)->nullable()->comment('Invitados para el acta');
            $table->string('codopaausente', 2000)->nullable()->comment('Ausentes en el acta');
