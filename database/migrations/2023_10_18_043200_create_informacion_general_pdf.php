...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('informaciongeneralpdf', function (Blueprint $table) {
            ...
            $table->string('ingpdfnombre', 30)->comment('Nombre general para utilizar la consulta de la información en PDF');
            $table->string('ingpdftitulo', 80)->comment('Título de la información general del PDF');
