...
CREATE TABLE `colocacion` (
  ...
  `colofechahoradesembolso` datetime NOT NULL COMMENT 'Fecha y hora actual en el que se registra la colocacion',
  `colofechacolocacion` date NOT NULL COMMENT 'Fecha de desembolso del crédito',
