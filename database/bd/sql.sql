...
(33, 7, 'Suspender', 'Getionar suspención de vehículo', 'admin/direccion/transporte/suspenderVehiculo', 'no_transfer_icon', 5, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(34, 8, 'Línea de crédito', 'Gestionar línea de crédito', 'admin/cartera/lineaCredito', 'add_chart', 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(35, 8, 'Solicitud', 'Gestionar solicitud de crédito', 'admin/cartera/solicitud', 'add_card_icon', 2, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(36, 8, 'Aprobación', 'Aprobar solicitud de crédito', 'admin/cartera/aprobacion', 'credit_score_icon', 3, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(37, 8, 'Desembolso', 'Getionar desembolso', 'admin/cartera/desembolso', 'attach_money_icon', 4, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(38, 8, 'Historial S.C.', 'Getionar historial de solicitud de crédito', 'admin/cartera/historial', 'auto_stories_icon ', 5, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(39, 8, 'Cobranza', 'Getionar cobranza', 'admin/cartera/cobranza', 'table_chart_icon', 6, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(40, 9, 'Rutas', 'Getionar de rutas', 'admin/despacho/rutas', 'directions_icon', 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(41, 9, 'Planillas', 'Getionar planillas', 'admin/despacho/planillas', 'no_crash_icon', 2, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
(43, 9, 'Tiquetes', 'Getionar tiquetes', 'admin/despacho/tiquetes', 'card_travel_icon', 4, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(44, 9, 'Recibir', 'Getionar proceso de recibir planilla o encomienda', 'admin/despacho/recibirPlanilla', 'checklist_rtl_icon', 5, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(45, 9, 'Servico especial', 'Getionar planilla de servico especial', 'admin/despacho/servicioEspecial', 'taxi_alert_icon', 6, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
