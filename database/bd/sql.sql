...
(33, 'notificacionRedencionPuntos', 'Confirmación de acumulación de puntos en la fecha fechaPuntos', '<p style="text-align: justify;">Estimado <em><strong>nombrePersona</strong></em>,</p><p style="text-align: justify;">Es un placer para nosotros en la <strong><em>COOPERATIVA DE TRANSPORTADORES HACARITAMA</em></strong> informarle que se ha acreditado un total de $ <strong>valorRedimido </strong>a su cuenta como resultado de su lealtad y uso continuo de nuestros servicios de transporte.</p><p style="text-align: justify;">Estos puntos acumulados pueden ser redimidos en su pr&oacute;xima transacci&oacute;n con nosotros, brind&aacute;ndole la oportunidad de disfrutar de beneficios adicionales en su viaje.</p><p style="text-align: justify;">Apreciamos sinceramente su fidelidad y confianza en nosotros, y esperamos seguir siendo su elecci&oacute;n preferida para sus necesidades de transporte en el futuro.</p><p>&nbsp;</p><p style="text-align: justify;">Atentamente,</p><p style="text-align: justify;"><br><em><strong>nombreGerente</strong></em><br><em><strong>COOPERATIVA DE TRANSPORTADORES HACARITAMA</strong></em></p>', 1, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(1133, 9, '20019', 'Rincón Hondo', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(1134, 9, '20020', 'Cruce A Chiriguaná', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(1135, 9, '20021', 'Las Vejas', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(1136, 9, '20022', 'San Roque', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
1123,1124,1125,1126, 1127, 1128,1129, 1130, 1131,1132, 1133, 846, 1134, 1135, 1136);
...
(11, 'Atención usuario', 'repeat_one_icon', 11, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(12, 'Proceso automáticos', 'account_tree_icon', 12, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(13, 'Informes', 'assessment_icon', 13, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(14, 'Auditoria', 'add_road_icon', 14, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
(13, 2, 'Cuenta contable', 'Gestionar cuentas contables', 'admin/gestionar/cuentaContable', 'repeat_one_icon', 8, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
(30, 7, 'Tipos de vehiculos', 'Gestionar tipos de vehículos', 'admin/direccion/transporte/tipos', 'car_crash_icon', 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(31, 7, 'Vehículos', 'Gestionar vehículos', 'admin/direccion/transporte/vehiculos', 'electric_car_icon', 2, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(32, 7, 'Conductores', 'Gestionar conductores', 'admin/direccion/transporte/conductores', 'attach_money_icon', 3, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
(40, 8, 'Desembolso', 'Getionar desembolso', 'admin/cartera/desembolso', 'attach_money_icon', 4, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(41, 8, 'Historial S.C.', 'Getionar historial de solicitud de crédito', 'admin/cartera/historial', 'auto_stories_icon ', 5, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(42, 8, 'Cobranza', 'Getionar cobranza', 'admin/cartera/cobranza', 'table_chart_icon', 6, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(43, 9, 'Rutas', 'Getionar de rutas', 'admin/despacho/rutas', 'directions_icon', 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(44, 9, 'Planillas', 'Getionar planillas', 'admin/despacho/planillas', 'no_crash_icon', 2, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(45, 9, 'Encomiendas', 'Getionar encomiendas', 'admin/despacho/encomiendas', 'local_shipping_icon', 3, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(46, 9, 'Tiquetes', 'Getionar tiquetes', 'admin/despacho/tiquetes', 'card_travel_icon', 4, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(47, 9, 'Recibir', 'Getionar proceso de recibir planilla o encomienda', 'admin/despacho/recibirPlanilla', 'checklist_rtl_icon', 5, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(48, 9, 'Servico especial', 'Getionar planilla de servico especial', 'admin/despacho/servicioEspecial', 'taxi_alert_icon', 6, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(49, 10, 'Procesar', 'Procesar movimientos de caja', 'admin/caja/procesar', 'currency_exchange_icon', 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(50, 10, 'Pagar crédito', 'Pagar desembolso de crédito', 'admin/caja/entregarDesembolsoCredito', 'account_balance_icon', 2, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(51, 10, 'Consignar', 'Consignar en bancos', 'admin/caja/consigarBanco', 'price_check_icon', 3, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
