...
(27, 'solicitaFirmaContratoGerente', 'Solicitud de firma del contrato número  numeroContrato', '<p class=\"MsoNormal\" style=\"text-align: justify;\">Estimado <strong>nombreGerente</strong>,</p>\r\n<p class=\"MsoNormal\" style=\"text-align: justify;\">Cordial saludos.</p>\r\n<p class=\"MsoNormal\" style=\"text-align: justify;\">Quisiera recordarle que el contrato n&uacute;mero <strong>numeroContrato </strong>est&aacute; pendiente de su firma. Este contrato es de suma importancia para nuestra cooperativa y su pronta atenci&oacute;n es crucial para avanzar en nuestros procesos.</p>\r\n<p class=\"MsoNormal\" style=\"text-align: justify;\">Por favor, le insto a que acceda al sistema ERP de la empresa lo antes posible para proceder con la firma electr&oacute;nica del mencionado contrato. Este paso es esencial para mantener nuestros procedimientos en curso y garantizar un flujo de trabajo eficiente.</p>\r\n<p class=\"MsoNormal\" style=\"text-align: justify;\">Agradecemos su pronta atenci&oacute;n a este asunto y quedamos a disposici&oacute;n para cualquier consulta o asistencia que pueda necesitar.</p>\r\n<p class=\"MsoNormal\" style=\"text-align: justify;\">&nbsp;</p>\r\n<p class=\"MsoNormal\" style=\"text-align: justify;\">Atentamente,</p>\r\n<p class=\"MsoNormal\" style=\"text-align: justify;\">&nbsp;</p>\r\n<p class=\"MsoNormal\" style=\"text-align: justify;\"><strong>nombreUsuario</strong><br>COOPERATIVA DE TRANSPORTADORES HACARITAMA</p>', 1, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
(36, 8, 'Línea de crédito', 'Gestionar línea de crédito', 'admin/cartera/lineaCredito', 'add_chart', 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(37, 8, 'Solicitud', 'Gestionar solicitud de crédito', 'admin/cartera/solicitud', 'add_card_icon', 2, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(38, 8, 'Aprobación', 'Aprobar solicitud de crédito', 'admin/cartera/aprobacion', 'credit_score_icon', 3, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(39, 8, 'Desembolso', 'Getionar desembolso', 'admin/cartera/desembolso', 'attach_money_icon', 4, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(40, 8, 'Historial S.C.', 'Getionar historial de solicitud de crédito', 'admin/cartera/historial', 'auto_stories_icon ', 5, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(41, 8, 'Cobranza', 'Getionar cobranza', 'admin/cartera/cobranza', 'table_chart_icon', 6, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(42, 9, 'Rutas', 'Getionar de rutas', 'admin/despacho/rutas', 'directions_icon', 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(43, 9, 'Planillas', 'Getionar planillas', 'admin/despacho/planillas', 'no_crash_icon', 2, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(44, 9, 'Encomiendas', 'Getionar encomiendas', 'admin/despacho/encomiendas', 'local_shipping_icon', 3, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(45, 9, 'Tiquetes', 'Getionar tiquetes', 'admin/despacho/tiquetes', 'card_travel_icon', 4, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(46, 9, 'Recibir', 'Getionar proceso de recibir planilla o encomienda', 'admin/despacho/recibirPlanilla', 'checklist_rtl_icon', 5, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(47, 9, 'Servico especial', 'Getionar planilla de servico especial', 'admin/despacho/servicioEspecial', 'taxi_alert_icon', 6, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(48, 10, 'Procesar', 'Procesar movimientos de caja', 'admin/caja/procesar', 'currency_exchange_icon', 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(49, 10, 'Pagar crédito', 'Pagar desembolso de crédito', 'admin/caja/entregarDesembolsoCredito', 'account_balance_icon', 2, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
(52, 11, 'Solicitud', 'Gestionar solicitud de atención al usuario', 'admin/antencion/usuario/solicitud', 'clean_hands_icon', 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(53, 12, 'Verificar', 'Verificar proceso automáticos del dia', 'admin/procesosAutomaticos', 'spellcheck_icon', 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
