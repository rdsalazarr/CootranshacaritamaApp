...
(13, 3, 'Acta', 'Gestionar actas', 'admin/produccion/documental/acta', 'local_library_icon', 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(14, 3, 'Certificado', 'Gestionar certificados', 'admin/produccion/documental/certificado', 'note_icon', 2, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(15, 3, 'Circular', 'Gestionar circulares', 'admin/produccion/documental/circular', 'menu_book_icon', 3, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(16, 3, 'Citación', 'Gestionar citaciones', 'admin/produccion/documental/citacion', 'collections_bookmark_icon', 4, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(17, 3, 'Constancia', 'Gestionar constancias', 'admin/produccion/documental/constancia', 'auto_stories_icon', 5, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(18, 3, 'Oficio', 'Gestionar oficios', 'admin/produccion/documental/oficio', 'library_books_icon', 6, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(19, 3, 'Firmar', 'Firmar documentos', 'admin/produccion/documental/firmar', 'import_contacts_icon', 7, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(20, 4, 'Documento entrante', 'Gestionar documento entrante', 'admin/radicacion/documento/entrante', 'post_add_icon', 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(21, 4, 'Anular radicado', 'Gestionar anulado de radicado', 'admin/radicacion/documento/anular', 'layers_clear_icon', 2, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(22, 4, 'Bandeja de radicado', 'Gestionar bandeja de radicado', 'admin/radicacion/documento/bandeja', 'content_paste_go_icon', 3, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(23, 5, 'Gestionar', 'Gestionar archivo histórico', 'admin/archivo/historico/gestionar', 'ac_unit_icon', 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(24, 5, 'Consultar', 'Gestionar consulta del archivo histórico', 'admin/archivo/historico/consultar', 'find_in_page_icon', 2, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(25, 6, 'Procesar', 'Procesar asociados', 'admin/gestionar/asociados', 'person_add_alt1_icon', 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(26, 6, 'Desvincular', 'Desvincular asociado', 'admin/gestionar/desvincularAsociado', 'person_remove_icon', 2, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(27, 6, 'Sancionar', 'Getionar sanciones asociado', 'admin/gestionar/sancionarAsociado', 'person_add_disabled_icon', 3, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(28, 6, 'Inactivos', 'Gestionar asociados inactivos', 'admin/gestionar/asociadosInactivos', 'person_off_icon', 4, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
(33, 7, 'Distribución', 'Getionar Distribución de vehículo', 'admin/direccion/transporte/distribucionVehiculos', 'local_car_wash_icon', 5, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(34, 7, 'Suspender', 'Getionar suspención de vehículo', 'admin/direccion/transporte/suspenderVehiculo', 'no_transfer_icon', 6, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),

(35, 8, 'Línea de crédito', 'Gestionar línea de crédito', 'admin/cartera/lineaCredito', 'add_chart', 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(36, 8, 'Solicitud', 'Gestionar solicitud de crédito', 'admin/cartera/solicitud', 'add_card_icon', 2, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(37, 8, 'Aprobación', 'Aprobar solicitud de crédito', 'admin/cartera/aprobacion', 'credit_score_icon', 3, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(38, 8, 'Desembolso', 'Getionar desembolso', 'admin/cartera/desembolso', 'attach_money_icon', 4, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(39, 8, 'Historial S.C.', 'Getionar historial de solicitud de crédito', 'admin/cartera/historial', 'auto_stories_icon ', 5, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(40, 8, 'Cobranza', 'Getionar cobranza', 'admin/cartera/cobranza', 'table_chart_icon', 6, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(41, 9, 'Rutas', 'Getionar de rutas', 'admin/despacho/rutas', 'directions_icon', 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(42, 9, 'Planillas', 'Getionar planillas', 'admin/despacho/planillas', 'no_crash_icon', 2, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(43, 9, 'Encomiendas', 'Getionar encomiendas', 'admin/despacho/encomiendas', 'local_shipping_icon', 3, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(44, 9, 'Tiquetes', 'Getionar tiquetes', 'admin/despacho/tiquetes', 'card_travel_icon', 4, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(45, 9, 'Recibir', 'Getionar proceso de recibir planilla o encomienda', 'admin/despacho/recibirPlanilla', 'checklist_rtl_icon', 5, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(46, 9, 'Servico especial', 'Getionar planilla de servico especial', 'admin/despacho/servicioEspecial', 'taxi_alert_icon', 6, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
