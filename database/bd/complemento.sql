...
UPDATE `cuentacontable` SET `cueconnombre` = 'desembolso', `cuecondescripcion` = 'DESEMBOLSOS' WHERE `cuentacontable`.`cueconid` = 3; UPDATE `cuentacontable` SET `cueconnombre` = 'pagoMensualidad', `cuecondescripcion` = 'MENSUALIDADES' WHERE `cuentacontable`.`cueconid` = 4; UPDATE `cuentacontable` SET `cueconnombre` = 'pagoMensualidadTotal', `cuecondescripcion` = 'MENSUALIDAD TOTAL' WHERE `cuentacontable`.`cueconid` = 5; UPDATE `cuentacontable` SET `cueconnombre` = 'pagoCuotaCredito', `cuecondescripcion` = 'PAGO CUOTA CRÉDITO' WHERE `cuentacontable`.`cueconid` = 6; UPDATE `cuentacontable` SET `cueconnombre` = 'pagoCreditoTotal', `cuecondescripcion` = 'PAGO CRÉDITO TOTAL' WHERE `cuentacontable`.`cueconid` = 7;
UPDATE `cuentacontable` SET `cueconnombre` = 'pagoSancion', `cuecondescripcion` = 'PAGO SANCIÓN' WHERE `cuentacontable`.`cueconid` = 8; UPDATE `cuentacontable` SET `cueconnombre` = 'pagoMensualidadParcial', `cuecondescripcion` = 'PAGO MENSUALIDAD PARCIAL' WHERE `cuentacontable`.`cueconid` = 9; UPDATE `cuentacontable` SET `cueconnombre` = 'pagoTiquete', `cuecondescripcion` = 'PAGO DE TIQUETE' WHERE `cuentacontable`.`cueconid` = 10; UPDATE `cuentacontable` SET `cueconnombre` = 'fondoReposicion', `cuecondescripcion` = 'FONDO REPOSICION' WHERE `cuentacontable`.`cueconid` = 11; UPDATE `cuentacontable` SET `cueconnombre` = 'pagoEstampilla', `cuecondescripcion` = 'PAGO ESTAMIPILLA' WHERE `cuentacontable`.`cueconid` = 12; 
UPDATE `cuentacontable` SET `cueconnombre` = 'pagoSeguro', `cuecondescripcion` = 'PAGO SEGURO' WHERE `cuentacontable`.`cueconid` = 13; UPDATE `cuentacontable` SET `cueconnombre` = 'descuentoTiquete', `cuecondescripcion` = 'DESCUENTO TIQUETE' WHERE `cuentacontable`.`cueconid` = 14; UPDATE `cuentacontable` SET `cueconnombre` = 'comisionEncomiendaEmpresa', `cuecondescripcion` = 'COMISIÓN ENCOMIENDA EMPRESA' WHERE `cuentacontable`.`cueconid` = 16; UPDATE `cuentacontable` SET `cueconnombre` = 'comisionEncomiendaAgencia', `cuecondescripcion` = 'COMISIÓN ENCOMIENDA AGENCIA' WHERE `cuentacontable`.`cueconid` = 17; UPDATE `cuentacontable` SET `cueconnombre` = 'comisionEncomiendaVehiculo', `cuecondescripcion` = 'COMISIÓN ENCOMIENDA VEHÍCULO' WHERE `cuentacontable`.`cueconid` = 18; 
UPDATE `cuentacontable` SET `cueconnombre` = 'pagoEncomiendaDomicilio', `cuecondescripcion` = 'PAGO ENCOMIENDA A DOMICILIO' WHERE `cuentacontable`.`cueconid` = 19; UPDATE `cuentacontable` SET `cueconnombre` = 'pagoEncomiendaContraentrega', `cuecondescripcion` = 'PAGO ENCOMIENDA CONTRAENTREGA' WHERE `cuentacontable`.`cueconid` = 20;
