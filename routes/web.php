...
Route::get('/download/certificado/conductor/{documento}/{ruta}', [DownloadFileController::class, 'certificadoConductor']);
...
Route::post('/admin/eliminar/certificado/conductor', [EliminarAchivosController::class, 'certificado']);
